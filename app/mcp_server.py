...
def build_mcp() -> FastMCP:
    ...
    def upsert_collection_policy(
        ...
        """Store the meeting-approved include/exclude policy for a collector."""
    ...
    @mcp.tool()
    def list_collection_policies() -> ListResponse:
        """Return current collection include/exclude policies."""
        return ListResponse(result=db.list_collection_policies())
